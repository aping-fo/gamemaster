...
import com.luckygames.wmxz.gamemaster.dao.ServerExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.ServerExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.ServerExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ServerSqlProvider {

    public String countByExample(ServerExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ServerExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Server record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ServerExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Server record = (Server) parameter.get("record");
        ServerExample example = (ServerExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, ServerExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
