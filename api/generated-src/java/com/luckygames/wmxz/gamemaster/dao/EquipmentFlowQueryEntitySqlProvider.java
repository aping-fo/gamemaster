...
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowQueryEntity;
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowQueryEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowQueryEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowQueryEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class EquipmentFlowQueryEntitySqlProvider {

    public String countByExample(EquipmentFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("equipment_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(EquipmentFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("equipment_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(EquipmentFlowQueryEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("equipment_flowquery");
    ...
    public String selectByExample(EquipmentFlowQueryEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EquipmentFlowQueryEntity record = (EquipmentFlowQueryEntity) parameter.get("record");
        EquipmentFlowQueryEntityExample example = (EquipmentFlowQueryEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("equipment_flowquery");
    ...
    protected void applyWhere(SQL sql, EquipmentFlowQueryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
