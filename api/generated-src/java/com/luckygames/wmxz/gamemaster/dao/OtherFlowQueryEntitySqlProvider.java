...
import com.luckygames.wmxz.gamemaster.dao.OtherFlowQueryEntity;
import com.luckygames.wmxz.gamemaster.dao.OtherFlowQueryEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.OtherFlowQueryEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.OtherFlowQueryEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OtherFlowQueryEntitySqlProvider {

    public String countByExample(OtherFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("other_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(OtherFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("other_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(OtherFlowQueryEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("other_flowquery");
    ...
    public String selectByExample(OtherFlowQueryEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OtherFlowQueryEntity record = (OtherFlowQueryEntity) parameter.get("record");
        OtherFlowQueryEntityExample example = (OtherFlowQueryEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("other_flowquery");
    ...
    protected void applyWhere(SQL sql, OtherFlowQueryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
