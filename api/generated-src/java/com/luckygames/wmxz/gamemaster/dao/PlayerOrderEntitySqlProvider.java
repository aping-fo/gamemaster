...
import com.luckygames.wmxz.gamemaster.dao.PlayerOrderEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.PlayerOrderEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.PlayerOrderEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PlayerOrderEntitySqlProvider {

    public String countByExample(PlayerOrderEntityExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(PlayerOrderEntityExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(PlayerOrderEntity record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(PlayerOrderEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PlayerOrderEntity record = (PlayerOrderEntity) parameter.get("record");
        PlayerOrderEntityExample example = (PlayerOrderEntityExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, PlayerOrderEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
