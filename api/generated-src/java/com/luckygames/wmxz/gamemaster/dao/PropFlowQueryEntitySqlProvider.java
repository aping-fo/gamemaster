...
import com.luckygames.wmxz.gamemaster.dao.PropFlowQueryEntity;
import com.luckygames.wmxz.gamemaster.dao.PropFlowQueryEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.PropFlowQueryEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.PropFlowQueryEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PropFlowQueryEntitySqlProvider {

    public String countByExample(PropFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("prop_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(PropFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("prop_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(PropFlowQueryEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("prop_flowquery");
    ...
    public String selectByExample(PropFlowQueryEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PropFlowQueryEntity record = (PropFlowQueryEntity) parameter.get("record");
        PropFlowQueryEntityExample example = (PropFlowQueryEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("prop_flowquery");
    ...
    protected void applyWhere(SQL sql, PropFlowQueryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
