...
@Table(name="player_order")
public class PlayerOrderEntity extends BaseEntity {
    ...
    public Integer getCharGold() {
        return charGold;
    }

    public void setCharGold(Integer charGold) {
    ...
    public Date getRechargedDate() {
        return rechargedDate;
    }

    public void setRechargedDate(Date rechargedDate) {
