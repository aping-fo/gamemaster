...
import com.luckygames.wmxz.gamemaster.dao.EmailFlowEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.EmailFlowEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.EmailFlowEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class EmailFlowEntitySqlProvider {

    public String countByExample(EmailFlowEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("email_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(EmailFlowEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("email_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(EmailFlowEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("email_flow");
    ...
    public String selectByExample(EmailFlowEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EmailFlowEntity record = (EmailFlowEntity) parameter.get("record");
        EmailFlowEntityExample example = (EmailFlowEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("email_flow");
    ...
    protected void applyWhere(SQL sql, EmailFlowEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
