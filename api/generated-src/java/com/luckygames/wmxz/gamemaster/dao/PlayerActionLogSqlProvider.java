...
import com.luckygames.wmxz.gamemaster.dao.PlayerActionLog;
import com.luckygames.wmxz.gamemaster.dao.PlayerActionLogExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.PlayerActionLogExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.PlayerActionLogExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PlayerActionLogSqlProvider {

    public String countByExample(PlayerActionLogExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(PlayerActionLogExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(PlayerActionLog record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(PlayerActionLogExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PlayerActionLog record = (PlayerActionLog) parameter.get("record");
        PlayerActionLogExample example = (PlayerActionLogExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, PlayerActionLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
