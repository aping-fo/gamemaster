...
import com.luckygames.wmxz.gamemaster.dao.RechargeDailyExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.RechargeDailyExample.Criterion;
...
public class RechargeDailySqlProvider {
    ...
    public String countByExample(RechargeDailyExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(RechargeDailyExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(RechargeDaily record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(RechargeDailyExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RechargeDaily record = (RechargeDaily) parameter.get("record");
        RechargeDailyExample example = (RechargeDailyExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, RechargeDailyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
