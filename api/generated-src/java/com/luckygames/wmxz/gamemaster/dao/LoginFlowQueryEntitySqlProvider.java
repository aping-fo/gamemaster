...
import com.luckygames.wmxz.gamemaster.dao.LoginFlowQueryEntity;
import com.luckygames.wmxz.gamemaster.dao.LoginFlowQueryEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.LoginFlowQueryEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.LoginFlowQueryEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class LoginFlowQueryEntitySqlProvider {

    public String countByExample(LoginFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("login_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(LoginFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("login_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(LoginFlowQueryEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("login_flowquery");
    ...
    public String selectByExample(LoginFlowQueryEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        LoginFlowQueryEntity record = (LoginFlowQueryEntity) parameter.get("record");
        LoginFlowQueryEntityExample example = (LoginFlowQueryEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("login_flowquery");
    ...
    protected void applyWhere(SQL sql, LoginFlowQueryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
