...
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.EquipmentFlowEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class EquipmentFlowEntitySqlProvider {

    public String countByExample(EquipmentFlowEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("equipment_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(EquipmentFlowEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("equipment_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(EquipmentFlowEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("equipment_flow");
    ...
    public String selectByExample(EquipmentFlowEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EquipmentFlowEntity record = (EquipmentFlowEntity) parameter.get("record");
        EquipmentFlowEntityExample example = (EquipmentFlowEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("equipment_flow");
    ...
    protected void applyWhere(SQL sql, EquipmentFlowEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
