...
import com.luckygames.wmxz.gamemaster.dao.MoneyFlowQueryEntity;
import com.luckygames.wmxz.gamemaster.dao.MoneyFlowQueryEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.MoneyFlowQueryEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.MoneyFlowQueryEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class MoneyFlowQueryEntitySqlProvider {

    public String countByExample(MoneyFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("money_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(MoneyFlowQueryEntityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("money_flowquery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(MoneyFlowQueryEntity record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("money_flowquery");
    ...
    public String selectByExample(MoneyFlowQueryEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MoneyFlowQueryEntity record = (MoneyFlowQueryEntity) parameter.get("record");
        MoneyFlowQueryEntityExample example = (MoneyFlowQueryEntityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("money_flowquery");
    ...
    protected void applyWhere(SQL sql, MoneyFlowQueryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
