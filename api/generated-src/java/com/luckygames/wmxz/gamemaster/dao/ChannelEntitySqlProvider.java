...
import com.luckygames.wmxz.gamemaster.dao.ChannelEntityExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.ChannelEntityExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.ChannelEntityExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ChannelEntitySqlProvider {

    public String countByExample(ChannelEntityExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ChannelEntityExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(ChannelEntity record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ChannelEntityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ChannelEntity record = (ChannelEntity) parameter.get("record");
    ...
    protected void applyWhere(SQL sql, ChannelEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
