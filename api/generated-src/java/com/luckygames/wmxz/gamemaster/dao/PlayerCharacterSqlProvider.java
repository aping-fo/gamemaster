...
import com.luckygames.wmxz.gamemaster.dao.PlayerCharacter;
import com.luckygames.wmxz.gamemaster.dao.PlayerCharacterExample.Criteria;
import com.luckygames.wmxz.gamemaster.dao.PlayerCharacterExample.Criterion;
import com.luckygames.wmxz.gamemaster.dao.PlayerCharacterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PlayerCharacterSqlProvider {

    public String countByExample(PlayerCharacterExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(PlayerCharacterExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(PlayerCharacter record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(PlayerCharacterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PlayerCharacter record = (PlayerCharacter) parameter.get("record");
        PlayerCharacterExample example = (PlayerCharacterExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, PlayerCharacterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
