...
(function ($) {
    $.fn.extend({
        pagination: function (opts) {
            ...
            return this.each(function () {
                ...
                $this.html(DWZ.frag["pagination"].replaceAll("#pageNumFrag#", pageNumFrag).replaceAll("#pageNum#", pc.getCurrentPage())).find("li").hoverClass();
            ...
            return this.each(function () {
                var $this = $(this).css({cursor: "pointer"}).click(function () {
                    ...
                    dwzPageBreak({
                        ...
                        rel: op.rel,
                        data: {orderField: orderField, orderDirection: orderDirection}
                    });
                });
    ...
    $.extend(Pagination.prototype, {
        ...
        numPages: function () {
            return Math.ceil(this.opts.totalElements / this.opts.pageSize);
        },
        ...
        getCurrentPage: function () {
            var pageNum = parseInt(this.opts.pageNum);
