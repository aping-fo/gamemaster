...
public class RankingsFlowSqlProvider {
    public String searchPage(RankingsFlowSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM rankings_flow where 1=1 ");
