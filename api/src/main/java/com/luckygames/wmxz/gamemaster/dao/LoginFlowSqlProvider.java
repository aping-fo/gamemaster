...
public class LoginFlowSqlProvider {
    public String searchPage(LoginFlowSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM login_flow where 1=1 ");
