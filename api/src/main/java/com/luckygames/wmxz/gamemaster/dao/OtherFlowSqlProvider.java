...
public class OtherFlowSqlProvider {
    public String searchPage(OtherFlowSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM other_flow where 1=1 ");
