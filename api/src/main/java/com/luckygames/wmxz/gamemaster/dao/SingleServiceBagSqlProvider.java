...
public class SingleServiceBagSqlProvider {
    public String searchPage(SingleServiceBagSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM single_service_bag where 1=1 ");
