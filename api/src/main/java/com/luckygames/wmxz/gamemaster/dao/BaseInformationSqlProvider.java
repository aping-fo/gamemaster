...
public class BaseInformationSqlProvider {
    ...
    public String updateByCharId(BaseInformation baseInformation) {
        StringBuilder sql = new StringBuilder("UPDATE base_information SET account_authority = #{accountAuthority} WHERE char_id = #{charId}");
        return sql.toString();
    }
}
