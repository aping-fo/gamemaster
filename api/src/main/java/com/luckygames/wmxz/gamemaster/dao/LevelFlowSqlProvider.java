...
public class LevelFlowSqlProvider {
    public String searchPage(LevelFlowSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM level_flow where 1=1 ");
