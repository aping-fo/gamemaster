...
public class MoneyFlowSqlProvider {
    public String searchPage(MoneyFlowSearchQuery query) {
        StringBuilder sql = new StringBuilder("SELECT * FROM money_flow where 1=1 ");
