...
/**
 *
 * @param {Object} args {pageNum:"",pageSize:"",orderField:"",orderDirection:""}
...
function _getPagerForm($parent, args) {
    ...
    if (form) {
        ...
        if (args["pageSize"]) form[DWZ.pageInfo.pageSize].value = args["pageSize"];
 ...
 * data: pagerForm参数 {pageNum:"n", pageSize:"n", orderField:"xxx", orderDirection:""}
 * callback: 加载完成回调函数
 */
function dwzPageBreak(options) {
    var op = $.extend({
        targetType: "navTab",
        rel: "",
        data: {pageNum: "", pageSize: "", orderField: "", orderDirection: ""},
        callback: null
    }, options);
...
/**
 * 处理navTab中的分页和排序
 * @param args {pageNum:"n", pageSize:"n", orderField:"xxx", orderDirection:""}
